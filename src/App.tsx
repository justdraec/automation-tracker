...
type ActiveView = 'chat' | 'list' | 'buildlist'
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="bg-surface-container-low rounded-full pl-9 pr-4 py-1.5 text-sm w-48 border border-outline-variant/20 outline-none focus:ring-2 focus:ring-primary/10 focus:border-primary/30 transition-all placeholder:text-on-surface-variant/40"
              />
            </div>
            <div className="w-8 h-8 rounded-full bg-primary-container text-on-primary text-xs font-bold flex items-center justify-center">
              TF
            </div>
          </div>
        </header>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-surface-container-lowest rounded-2xl p-6 w-full max-w-sm shadow-2xl">
            ...
            <input
              ...
              autoFocus
              className="w-full px-4 py-3 rounded-xl border border-outline-variant bg-surface-container-low text-sm
            ...
            <div className="flex gap-2 mt-4">
              <button onClick={checkPassword} className="flex-1 py-2.5 rounded-full bg-primary text-on-primary text-sm font-semibold hover:opacity-90 transition-all shadow-lg shadow-primary/20">
                Unlock
              </button>
              <button onClick={() => setShowPwPrompt(false)} className="flex-1 py-2.5 rounded-full border border-outline-variant text-on-surface-variant text-sm font-medium hover:bg-surface-container-low transition-colors">
                Cancel
              </button>
            </div>
          </div>
